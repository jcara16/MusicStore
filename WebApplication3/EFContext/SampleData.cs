...
namespace MusicStoree.EFContext
{
    public class SampleData : DropCreateDatabaseIfModelChanges<MusicStoreDB>
    {
        protected override void Seed(MusicStoreDB context)
        {
            ...
            new List<Album>
            {
                new Album { Title = "The Best Of Men At Work", Genre = genres.Single(g => g.Name == "Rock"), Price = 8.99M, Artist = artists.Single(a => a.Name == "Men At Work"), AlbumArtUrl = "/Content/Images/rock-music.jpg" },
